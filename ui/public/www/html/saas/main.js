"use strict";
(self["webpackChunksaas"] = self["webpackChunksaas"] || []).push([["main"],{
...
const routes = [
    {
        path: 'user/signin',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_anonymous_signin_signin_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./modules/anonymous/signin/signin.module */ 292)).then(m => m.SigninModule)
    },
    {
        path: 'user/signup',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_anonymous_signup_signup_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./modules/anonymous/signup/signup.module */ 6758)).then(m => m.SignupModule)
    },
    {
        path: 'dashboard',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_modules_auth_dashboard_dashboard_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./modules/auth/dashboard/dashboard.module */ 7210)).then(m => m.DashboardModule)
    }
];
